...
def install_for_batch(files_to_install, keep_source):
    """Install files (called from batch processing)

    Args:
        files_to_install: List of file info dicts from scan_for_batch
        keep_source: bool, True = keep in downloads

    Returns:
        dict with stats (installed, errors, collisions)
    """
    installed = 0
    errors = 0
    collisions = 0
